...
namespace Voxell.Rasa
{
  public abstract class RasaNode : ScriptableObject
  {
    ...
    /// <summary>Get port locations based on field name.</summary>
    ...
    /// <summary>Generate input port infos.</summary>
    public abstract List<PortInfo> CreateInputPorts();
    /// <summary>Generate output port infos.</summary>
    public abstract List<PortInfo> CreateOutputPorts();
    #endregion

    #region Connection Actions
    /// <summary>Actions to perform when input port is connected.</summary>
    ...
    /// <summary>Actions to perform when input port is disconnected.</summary>
    /// <returns>true if succeeds, otherwise, false</returns>
    public abstract bool OnRemoveInputPort(RasaNode rasaNode, Type portType, string portName);
    /// <summary>Actions to perform when output port is connected.</summary>
    /// <returns>true if succeeds, otherwise, false</returns>
    public abstract bool OnAddOutputPort(RasaNode rasaNode, Type portType, string portName);
    /// <summary>Actions to perform when output port is disconnected.</summary>
    /// <returns>true if succeeds, otherwise, false</returns>
